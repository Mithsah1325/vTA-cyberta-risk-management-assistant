...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      console.error('Database unavailable, continuing without chat history persistence:', dbError);
    }

    // Retrieve recent chat history for context
    const chatHistory = chatCollection
...
Please use this context to inform your response to the user's latest message.`
      ...
      const chatInteractionResult = chatCollection
